        ...
        <div style={{ flex: 1, overflowY: "auto", padding: isMobile ? "12px 10px" : "14px 20px", background: C.bg }}>
          ...
          {tab === "fin" && (
            <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              <div style={{ fontSize: 12, fontWeight: 700, color: C.m, padding: "2px 0 4px" }}>핵심 재무지표</div>
              <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: 10 }}>
              ...
              <div style={{ borderTop: `1px solid ${C.b}`, margin: "2px 0" }} />
              <div style={{ fontSize: 12, fontWeight: 700, color: C.m, padding: "2px 0 4px" }}>매출 성장 추이</div>
